...
export function RivalryFeature(){return <section id="rivalries" className="rivalry-editorial wrap section" aria-labelledby="rivalry-title">
 ...
 <Reveal className="rivalry-editorial-copy"><p className="kicker">THE COLOURS CHANGE. THE PASSION DOESN’T.</p><h2 id="rivalry-title">OLD RIVALRIES.<br/><span>NEW CHAPTERS.</span></h2><p className="rivalry-nations">INDIA <span>×</span> PAKISTAN</p><p>Yuvraj Singh. Shahid Afridi. Two national colours, and a lifetime of cricket memories between them.</p><p>Meet the legends in the supplied Season 3 lineup, and follow the next chapter of WCL.</p><div className="rivalry-links"><Link to="/matches/s3-match-14">View the 10 October fixture <ArrowRight/></Link><Link to="/teams/pakistan">Pakistan Champions <ArrowRight/></Link></div><p className="source-note">Supplied schedule: India × Pakistan · 10 October 2026 · 19:30 UAE.</p></Reveal>
 </section>}
