// Organiser adoption is distinct from verified technical/provider readiness.
export const policyPack = Object.freeze({version:'1.0',status:'adopted-pending-activation',prepared:'2026-09-15',adopted:'2026-09-15',adoptedBy:'Nayeem Khan, WCL Owner',reference:'WCL-S3-ADOPT-20260915-001'});
